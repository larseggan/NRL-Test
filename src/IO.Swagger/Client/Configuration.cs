...
namespace IO.Swagger.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            //BasePath = "/nrl";
            // Lars: Read from appsettings.config
            BasePath = ConfigurationManager.AppSettings.Get("BasePath");
            //BasePath = "https://nrl-test.kartverket.no/nrl"; // Lars
        ...
        public string GetApiKeyWithPrefix(string apiKeyIdentifier)
        {
            ...
            // Lars: Read from appsettings.config
            apiKeyValue = ConfigurationManager.AppSettings.Get(apiKeyIdentifier);
            // apiKeyValue = ConfigurationManager.AppSettings.Get("Authorization");
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.6.59\n";
