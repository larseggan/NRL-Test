...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Polygon : Geometry,  IEquatable<Polygon>, IValidatableObject, OneOfGeometry 
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Polygon" /> class.
        /// </summary>
        /// <param name="coordinates">coordinates.</param>
        public Polygon(List<List<List<double?>>> coordinates = default(List<List<List<double?>>>), Crs crs = default(Crs), string type = default(string)) : base(crs, type)
        {
